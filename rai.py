...
file_paths = [
    "C:\\Users\\Jared\\Desktop\\AI911OPERATOR\\WhisperLive-main\\rai\\RescueAI_Synthetic_911_Scenarios.pdf",
    "C:\\Users\\Jared\\Desktop\\AI911OPERATOR\\WhisperLive-main\\rai\\RescueAI_Traffic_Accidents dialogue transcript.pdf"
]
...
# ===== MAIN UI =====
st.title("Run the 911 call through here...")
...
with st.sidebar:
    st.header("🧠 Rai – 911 Assistant Chatbot")
    st.write("Ask Rai questions about emergency protocols, traffic accidents, or dispatcher procedures.")
